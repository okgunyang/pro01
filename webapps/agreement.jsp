...
<%@ include file="./header.jsp" %>
        <div class="content">
            ...
            <section class="page" id="page1">
                <h2 class="page_tit">이용약관 및 개인정보 수집 동의</h2>
                <div class="page_wrap">
                	<div class="grp_textarea">
						<h3 class="cate_tit">이용약관 동의</h3>
...
제24조(재판권 및 준거법)
  ...
  ② “몰”과 이용자 간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
	...
	<div class="btn_fr">
        <input type="checkbox" id="ck_item1" name="ck_item1"> <label for="ck_item1">회원 약관에 대한 동의</label><br><br>
    </div>
</div>
<hr>
<div class="grp_textarea">
	<h3 class="cate_tit">개인 정보 수집에 대한 동의</h3>
	<textarea rows="30" cols="100" readonly>
개인정보처리방침
...
2) 시행일자 : 2018년 05월 01일 
						...
						<div class="btn_fr">
					        ...
					        <label for="ck_item2">개인정보 수집에 대한 동의</label><br><br><br><br>
					...
					in_btn1.addEventListener("click", function(){
						if(ck_item1.checked && ck_item2.checked){
							...
							alert("회원 약관 및 개인정보 수집에 대하여 모두 동의하지 않으셨습니다.");
							return;
						}
					});
					</script>
